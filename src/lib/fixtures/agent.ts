...
export const agentProposals: AgentProposal[] = [
  ...
  },
  {
    ...
    actionType: "report",
    urgency: "low",
    headline: "Weekly report drafted for Bright Smile — ready to send",
    reasoning:
      "Weekly client report for Bright Smile Dental has been drafted. Hero metrics: £423 spent, 31 leads, £13.64 CPL. Agent commentary written. Next-week recommendations included. Ready for your review before sending to Dr. Price.",
    metrics: [
      { label: "Period", value: "Apr 7 – Apr 13" },
      { label: "Spend", value: "£423" },
      { label: "Leads", value: "31" },
      { label: "CPL", value: "£13.64" },
      { label: "WoW CPL change", value: "-8%" },
    ],
    impactEstimate: "Client-facing, routine",
    affectedCreativeIds: [],
    status: "pending",
...
export const agentActivity: AgentActivity[] = [
  ...
  },
  {
    ...
    type: "report-draft",
    summary: "Drafted weekly report for Bright Smile Dental",
    clientId: "bright-smile",
  },
  {
    id: "act-006",
    timestamp: "2026-04-14T09:28:00Z",
    type: "report-draft",
    summary: "Drafted weekly report for Mayfair Dental Studio",
    clientId: "mayfair-dental",
  },
  {
    id: "act-007",
    timestamp: "2026-04-14T09:25:00Z",
    type: "report-draft",
    summary: "Drafted weekly report for Northside Family Dentistry",
    clientId: "northside-family",
  },
  {
    id: "act-008",
...
export const scheduledTasks: ScheduledTask[] = [
  ...
  },
  {
    ...
    cron: "Mondays at 08:00",
    description:
      "Drafts a weekly report per client — human reviews before sending.",
    status: "active",
